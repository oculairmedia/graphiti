...
pub async fn search_nodes(
    ...
    conn.fulltext_search_nodes(&sanitized_query, limit).await
...
pub async fn search_edges(
    ...
    let sanitized_query = sanitize_lucene_query(query);
    conn.fulltext_search_edges(&sanitized_query, limit).await
        .map_err(|e| crate::error::SearchError::Database(e.to_string()))
}
...
pub async fn search_episodes(
    ...
    let sanitized_query = sanitize_lucene_query(query);
    conn.fulltext_search_episodes(&sanitized_query, limit).await
        .map_err(|e| crate::error::SearchError::Database(e.to_string()))
}
...
mod tests {
    ...
    fn test_sanitize_lucene_query() {
        ...
        assert_eq!(sanitize_lucene_query("\"exact phrase\""), "\"exact phrase\"");
