...
async def test_qwen3():
    ...
    try:
        ...
        if successful_episodes:
            ...
            if node_result:
                count = node_result[0]['count'] if isinstance(node_result[0], dict) else node_result[0][0]
            ...
            if entity_result:
                count = entity_result[0]['count'] if isinstance(entity_result[0], dict) else entity_result[0][0]
            ...
            if rel_result:
                count = rel_result[0]['count'] if isinstance(rel_result[0], dict) else rel_result[0][0]
