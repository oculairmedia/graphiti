            ...
            if result:
                ...
                for row in result:
                    if isinstance(row, list) and len(row) >= 2:
                        ...
                        print(f"   - Name: {row.get('name', 'N/A')}, UUID: {row.get('uuid', 'N/A')}")
            else:
            ...
            if result:
                ...
                for row in result:
                    if isinstance(row, list) and len(row) >= 2:
                        ...
                        print(f"   - Name: {row.get('name', 'N/A')}, Created: {row.get('created', 'N/A')}")
            else:
            ...
            if result:
                ...
                for row in result:
                    if isinstance(row, list) and len(row) >= 2:
                        ...
                        print(f"   - {row.get('rel_type', 'Unknown')}: {row.get('count', 0)} relationships")
            else:
