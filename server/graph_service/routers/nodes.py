...
from graph_service.dto.nodes import UpdateNodeSummaryRequest, NodeResponse
from graph_service.zep_graphiti import ZepGraphitiDep

router = APIRouter()


@router.patch('/nodes/{node_uuid}/summary', status_code=status.HTTP_200_OK, response_model=NodeResponse)
async def update_node_summary(
    node_uuid: str,
    request: UpdateNodeSummaryRequest,
