...
class TestCentralityCalculateEndpoint:
    ...
    async def test_calculate_all_centralities_success(
        self, mock_get_graphiti, client, mock_graphiti
    ):
        ...
        with patch('graph_service.routers.centrality.calculate_all_centralities') as mock_calc:
            ...
            response = client.post('/centrality/calculate', json={'recalculate': True})
    ...
    async def test_calculate_specific_nodes(self, mock_get_graphiti, client, mock_graphiti):
        ...
        with patch('graph_service.routers.centrality.calculate_all_centralities') as mock_calc:
            ...
            response = client.post(
                '/centrality/calculate', json={'node_ids': node_ids, 'recalculate': False}
            )

            assert response.status_code == 200
            mock_calc.assert_called_once_with(
                mock_graphiti.driver, node_ids=node_ids, recalculate=False
            )
...
class TestPageRankEndpoint:
    ...
    @patch('graph_service.routers.centrality.get_graphiti')
    async def test_get_pagerank_all_nodes(
        self, mock_get_graphiti, client, mock_graphiti, sample_centrality_data
    ):
        ...
        mock_graphiti.driver.execute_query = AsyncMock(
            return_value=[
                {'uuid': d['node_id'], 'name': d['name'], 'pagerank': d['pagerank']}
    ...
    @patch('graph_service.routers.centrality.get_graphiti')
    async def test_get_pagerank_top_n(
        self, mock_get_graphiti, client, mock_graphiti, sample_centrality_data
    ):
...
class TestDegreeCentralityEndpoint:
    ...
    @patch('graph_service.routers.centrality.get_graphiti')
    async def test_get_degree_centrality(
        self, mock_get_graphiti, client, mock_graphiti, sample_centrality_data
    ):
...
class TestBetweennessCentralityEndpoint:
    ...
    @patch('graph_service.routers.centrality.get_graphiti')
    async def test_get_betweenness_centrality(
        self, mock_get_graphiti, client, mock_graphiti, sample_centrality_data
    ):
...
class TestCentralityReportEndpoint:
    ...
    @patch('graph_service.routers.centrality.get_graphiti')
    async def test_get_centrality_report(
        self, mock_get_graphiti, client, mock_graphiti, sample_centrality_data
    ):
    ...
    @patch('graph_service.routers.centrality.get_graphiti')
    async def test_get_centrality_report_node_not_found(
        self, mock_get_graphiti, client, mock_graphiti
    ):
